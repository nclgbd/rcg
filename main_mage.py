...
def get_args_parser():
    ...
    parser.add_argument(
        "--model",
        default="mage_vit_large_patch16",
        type=str,
        metavar="MODEL",
    ...
    parser.add_argument(
        "--use_rep", action="store_true", help="use representation as condition."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--evaluate", action="store_true", help="perform only evaluation"
    )
    parser.add_argument(
    ...
    # MAGE params
    parser.add_argument(
        "--mask_ratio_min", type=float, default=0.5, help="Minimum mask ratio"
    )
    parser.add_argument(
        "--mask_ratio_max", type=float, default=1.0, help="Maximum mask ratio"
    )
    parser.add_argument(
        "--mask_ratio_mu", type=float, default=0.55, help="Mask ratio distribution peak"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--augmentation", default="noaug", type=str, help="Augmentation type"
    )
