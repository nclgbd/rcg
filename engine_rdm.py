...
def train_one_epoch(
    ...
    log_iterator = metric_logger.log_every(data_loader, print_freq, header)
    for data_iter_step, (samples, class_label) in enumerate(log_iterator):
        # for data_iter_step, (samples, class_label) in enumerate(data_loader):
